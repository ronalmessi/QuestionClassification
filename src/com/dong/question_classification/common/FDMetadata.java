...
import com.dong.question_classification.utils.CheckUtils;
...
public class FDMetadata {
	...
	public FDMetadata(ProcessorType processorType, Configuration configuration) {
		...
		if(processorType == ProcessorType.TRAIN) {
			String trainInputRootDir = configuration.get("processor.dataset.train.input.file");
			...
			String testInputRootDir = configuration.get("processor.dataset.test.input.file");
