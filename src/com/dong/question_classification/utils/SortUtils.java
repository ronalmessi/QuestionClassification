package com.dong.question_classification.utils;
...
public class SortUtils {
	...
	/**
	 * 建堆方法: 调整堆中0~array.length/2个结点，保持堆的性质
	 */
	...
	private void adjustForDesc(int s, int m) {
		...
		while (i < m) {
			if (i + 1 < m
					&& array[i].getValue().getChi() > array[i + 1].getValue()
							.getChi()) { // 如果右孩子大于左孩子(找到比当前待调整结点大的孩子结点)
				i = i + 1;
			}
